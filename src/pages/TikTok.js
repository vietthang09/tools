...
export default function Tiktok() {
  ...
  useEffect(() => {
    document.title =
      "Tải video tiktok không logo - Lưu clip tiktok không water hình mờ";
  }, []);
          ...
          {data && (
            <div className="border rounded bg-white p-2 grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="flex justify-center items-center">
                <img className="h-64" src={data.cover[0]} alt="img" />
              </div>
              <div className="flex justify-center items-center">
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="text-blue-900 text-center space-y-4">
            ...
            <p className="w-1/2 mx-auto ">
              Tải video TikTok không có ảnh chìm hay logo.
            </p>
          </div>
          <div className="text-blue-900 text-center space-y-4">
            <img
        ...
        <div className="lg:w-2/3 mx-auto mt-8 p-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded space-y-8">
          <h1 className="text-3xl font-bold text-white text-center">
            Hướng dẫn tải video TikTok không có logo
          </h1>
          <div className="text-white">
            <h1 className="text-2xl font-bold">1. Tìm một video Tiktok</h1>
            <p className="text-lg">
          ...
          <div className="text-white">
            <h1 className="text-2xl font-bold">3. Tải video Tiktok</h1>
            <p className="text-lg">
